...
const studenttimetable_addReducer = (
  state = { loading: true, studenttimetabledata: {}, error: "" },
  action
) => {
  switch (action.type) {
...
const studenttimetable_getReducer = (
  state = { loading: true, studenttimetabledata: [], error: "" },
  action
) => {
  switch (action.type) {
    case GET_STUDENTTIMETABLE_REQUEST:
      return { ...state, loading: true };
    case GET_STUDENTTIMETABLE_SUCCESS:
      return {
        ...state,
        loading: false,
        studenttimetabledata: action.payload,
    ...
    case GET_STUDENTTIMETABLE_FAILURE:
      return {
        ...state,
        loading: false,
        studenttimetabledata: [],
...
export { studenttimetable_addReducer, studenttimetable_getReducer };
