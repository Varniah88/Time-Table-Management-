...
import {
  studenttimetable_addReducer,
  studenttimetable_getReducer,
} from "./generate_studenttimetable/studenttimetableReducer";

const rootReducer = combineReducers({
  locationtimetables: locationtimetable_getReducer,
  lecturertimetables: lecturertimetable_getReducer,
  studenttimetable_add: studenttimetable_addReducer,
  studenttimetable_get: studenttimetable_getReducer,
